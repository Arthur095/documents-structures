...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="xmlpath" select="document('../input/unziped/APRICOT/content.xml')"/>
            ...
            <teiHeader>
                <fileDesc>
                    <titleStmt>
                        ...
                        <respStmt>
                            <resp>Auto-generated xml with xsl stylesheet by</resp>
                            <name>Arthur Bouzard</name>
                        </respStmt>
                    </titleStmt>
                    <publicationStmt>
                        <publisher></publisher>
